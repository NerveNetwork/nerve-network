<template>
  <div v-loading="loading">
    ...
    <div class="pt-10">
      <Button v-if="!assetCanCross" class="w-full" @click="showReConnect">
        Switch Network
      </Button>
...
import { superLong, openL1Explorer, Minus, toThousands } from '@/utils/util'
...
const openAddress = () => {
  openL1Explorer('TBC', 'address', currentAddress.value)
}
...
const sendTx = async () => {
  ...
  try {
    ...
    if (result.txid) {
      ...
      handleTx(result.txid, amountRemark)
    } else {
