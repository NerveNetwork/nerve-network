<template>
  <div class="staking-record rounded-xl bg-card px-6 pb-6">
    <div class="py-3 text-base font-semibold sm:py-4 sm:text-lg">
      {{ $t('staking.staking13') }}
    </div>
...
import { divisionDecimals, Times, Plus, Minus, toThousands } from '@/utils/util'
