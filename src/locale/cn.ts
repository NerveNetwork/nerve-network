const cn = {
  ...
  mint: {
    ...
    mint5: '*Mint Fee',
    mint6: '请填入Mint Fee',
    mint7: '用户Mint需要支付的费用和资产类型',
    mint71: '请选择Mint Fee资产，并填写Mint Fee数量',
    mint72: '请选择一个Mint Fee资产',
    mint8: '*Mint Fee地址',
    mint9: '请填入用于接收Mint Fee或LP的地址',
    mint10: '*单次Mint数量',
    mint11: '请填入单次Mint数量',
    mint12: '用户单次Mint得到的资产数量',
    mint13: '*Mint次数限制',
    mint14: '请填入Mint次数限制',
    mint15: '每个地址可以Mint的最大次数',
    mint16: '*硬顶',
    mint17: '请设置硬顶数量',
    mint18: '用户最大可以Mint的资产数量',
    mint19: '*Mint开始时间',
    mint20: '请设置Mint开始时间',
    mint21: '允许开始Mint的日期和时间',
    mint22: '*Mint资产解锁时间',
    ...
    mint333: '请填入白名单优先Mint时间',
    mint34: '需要存入',
    mint35: '我清楚部署时，Mint Asset将被立即转入Mint系统，系统将收取5%的Mint费用',
    mint36: '高级',
    mint37: '名称/资产ID',
    mint38: '单次Mint/硬顶 ',
    mint39: 'Mint时间',
    ...
    mint52: '剩余/Mint次数限制',
    mint53: 'Mint次数',
    mint54: '我清楚Mint Fee或Mint Fee组合的LP将会被转账到部署者账户且无法被退回，本人已经明确知晓相关的风险。',
    mint55: '只能使用Nerve网络地址',
    mint56: '天',
    mint57: '已结束',
    mint58: 'Mint限制',
    mint59: '需要花费',
