const en = {
  ...
  home: {
    ...
    home3: '2 second confirmation,no rollback and fee',
    home4: 'Assets cross-chain,support 8+ chains',
    home5: 'Launch Swap ',
    home6: 'Launch Bridge',
    home7: 'Total Volume',
    home8: 'Highest APR',
